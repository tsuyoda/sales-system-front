        ...
        <Table className={classes.table} size='small'>
          ...
          <Menu anchorEl={anchorEl} open={!!anchorEl} onClose={handleActionsClose}>
            ...
            >
              ...
              <ListItemText primary='Histórico de Preços' />
            </MenuItem>
          ...
          <Dialog open={modalDeleteOpen} onClose={handleModalDeleteClose}>
            <DialogTitle>Você tem certeza que deseja excluir o produto abaixo?</DialogTitle>
            <DialogContent>
              <DialogContentText>
                <strong>Título</strong>: {currentProduct?.title}
              </DialogContentText>
            </DialogContent>
            <DialogActions>
